...
export const knowledgeDocuments = pgTable(
  ...
  (t) => [
    index('knowledge_documents_business_updated_idx').on(t.businessId, t.updatedAt),
    index('knowledge_documents_agent_updated_idx').on(t.agentId, t.updatedAt),
  ],
);
...
export const knowledgeChunks = pgTable(
  ...
  (t) => [
    index('knowledge_chunks_document_chunk_idx').on(t.documentId, t.chunkIndex),
    index('knowledge_chunks_business_agent_idx').on(t.businessId, t.agentId),
  ],
);
